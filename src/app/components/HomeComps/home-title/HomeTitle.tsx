...
const HomeTitle = () => {
    return (
        <React.Fragment>
            <div className="md:static sm:hidden">
                <div className={`-mb-9 flex flex-col`}>
                    <div className="relative flex h-10 flex-col overflow-y-hidden">
                        ...
                        <span
                            className={`textoCapa shuffleText h-full font-extralight`}
                        >
                            <span className="text-lime-400">lO',</span>{' '}
                            bEm-v!ndX Oa meu 3eb
                        </span>
                        <span
                            className={`textoCapa shuffleText h-full font-extralight`}
                        >
                            <span className="text-lime-400">!lá,</span>{' '}
                            Xe$-v!nd% Oa mOu 3eb
                        </span>
                        <span
                            className={`textoCapa shuffleText h-full font-extralight`}
                        >
                            <span className="text-lime-400">oXá,</span>{' '}
                            B3$-v!nd0 a* Meeu Web
                        </span>
                        <span
                            className={`textoCapa shuffleText h-full font-extralight`}
                        >
                            <span className="text-lime-400">#l¬,</span> b¬-v&ndo
                            ao *u w%b
                        </span>
                        <span
                            className={`textoCapa shuffleText h-full font-extralight`}
                        >
                            <span className="text-lime-400">Ç7á,</span> b%m-vYdo
                            ¨#3 ¨e% WEb
                        </span>
                        <span
                            className={`textoCapa shuffleText h-full font-extralight`}
                        >
                            <span className="text-lime-400">&@á,</span>{' '}
                            B3m-v!n*0 To mxu web
                        </span>
                    </div>
                    <div className="relative flex h-28 flex-col overflow-y-hidden ">
                        <span
                            className={`tituloCapa shuffleTitle h-full font-extrabold`}
                        >
                            PORTFÓLIO
                        </span>
                        <span
                        ...
                        <span
                            className={`tituloCapa shuffleTitle flex h-full 
            ...
            <div className="md:hidden sm:static">
            <div  className={`-mb-9 flex flex-col`}>
                            <span
                                className={`textoCapa font-extralight`}
                            >
                                <span className="text-lime-400">Olá,</span>{' '}
                                bem-vindo ao meu web
                            </span>
                        ...
                        <div
                            className={`w-full sm:mt-10 md:mt-10 lg:mt-5`}
                        >
                            <span className="textoCapa2">Criado por:</span>
                            <span
                                className="textoCapa2 ml-3 font-extrabold tracking-wide"
