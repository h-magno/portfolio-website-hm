        ...
        if (data[i].stargazers_count != '0') {
          ...
          return (
            <Link
              ...
              onMouseOver={() => {
                lastProjects?.forEach((e, i) => {
                  let projectGroup = document.getElementById(`main-projects-${i}`);
            ...
            >
              ...
              >
              {/*  */}
                <div id={`projectBoxId-${counter}`} className="projectBoxClass w-full h-96 rounded-3xl text-white  z-10 cursor-pointer p-10 relative bg-gradient-to-t from-blue-900 to-blue-600">
                  ...
                  <div className="h-1/3 flex text-white justify-center items-center">
                    <Link
                      ...
                      className="border w-48  flex items-center justify-center mx-4 rounded-xl lg:h-14 md:h-16 md:mt-10 p-2 bg-gray-400 hover:bg-lime-500 duration-500 "
                    >
                      VER MAIS
                    </Link>
                  </div>
